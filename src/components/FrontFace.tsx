...
backgroundSize: 'cover',}}>
        <h1  class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-black md:text-5xl lg:text-6xl">Master your job seeking journey</h1>
        <p class="mb-8 text-lg font-normal text-black lg:text-xl sm:px-16 lg:px-48">Here at Bamboo we tailor your resumes to the job description, saving you time on each application</p>
